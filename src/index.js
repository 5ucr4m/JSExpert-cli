...
const { argv: { componentName }} = yargs(hideBin(process.argv)).command(
    'skeleton', 'create project skeleton', (builder) => {
        return builder
            ...
            .example('skeleton -c product -c user', 'create a project with two domains')
        })
        .epilog('for more information, send me a email: 5ucr4m@gmail.com');
